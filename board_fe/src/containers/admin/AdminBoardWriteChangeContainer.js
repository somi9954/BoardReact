...
import ConfigBoardFormChange from '../../components/board/admin/ConfigBoardFormChange';

const AdminBoardWriteChangeContainer = ({ mode }) => {
...
export default AdminBoardWriteChangeContainer;
