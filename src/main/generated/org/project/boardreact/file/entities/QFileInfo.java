package org.project.boardreact.file.entities;
...
public class QFileInfo extends EntityPathBase<FileInfo> {
    ...
    private static final long serialVersionUID = -2094062821L;

    public static final QFileInfo fileInfo = new QFileInfo("fileInfo");

    public final org.project.boardreact.commons.entities.QBaseMember _super = new org.project.boardreact.commons.entities.QBaseMember(this);
