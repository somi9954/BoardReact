...
import org.project.boardreact.entities.QFileInfo;
...
public class FileInfoService {
    ...
    public void addFileInfo(FileInfo item) {
        ...
        String fileName = getFileName(seq, extension);
        ...
        String[] thumbsPath = Arrays.stream(Objects.requireNonNull(thumbDir.list((dir, name) -> name.contains("_" + fileName))))
        ...
        item.setThumbPath(Arrays.toString(thumbsPath));
        item.setThumbUrl(Arrays.toString(thumbsUrl));
    }
